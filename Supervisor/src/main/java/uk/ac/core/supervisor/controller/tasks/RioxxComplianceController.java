 ...
 */
@RestController
@RequestMapping("/task/repository/rioxx-compliance")
public class RioxxComplianceController extends TaskController {
    ...
    public TaskDescription execute(
        ...
        TaskDescription taskDescription = this.getTaskDescriptionFactory().create(TaskType.RIOXX_COMPLIANCE , repositoryTaskParameters);
