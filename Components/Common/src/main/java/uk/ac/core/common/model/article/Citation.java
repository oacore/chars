...
/**
 * Class representing citation. Citations are extracted from text using ParseCit
 * tool.
 *
...
public final class Citation {
    ...
    public Citation(ArticleMetadataBase am) {
        super();
        this.setAuthors(am.getAuthors());
        this.setTitle(am.getTitle());
        this.setDate(am.getDate());
        this.setRawString(this.getCitationText());
    }
