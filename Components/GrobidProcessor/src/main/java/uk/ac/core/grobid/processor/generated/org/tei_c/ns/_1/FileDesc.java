...
public class FileDesc {
    ...
    public String toString() {
        return "FileDesc{" + "titleStmt=" + titleStmt + ", editionStmt=" + editionStmt + ", publicationStmt=" + publicationStmt + ", seriesStmt=" + seriesStmt + ", notesStmt=" + notesStmt + ", sourceDescs=" + sourceDescs + ", sameAs=" + sameAs + ", prev=" + prev + ", corresps=" + corresps + ", synches=" + synches + ", next=" + next + ", selects=" + selects + ", excludes=" + excludes + ", copyOf=" + copyOf + ", space=" + space + ", id=" + id + ", n=" + n + ", base=" + base + ", rends=" + rends + ", renditions=" + renditions + ", lang=" + lang + ", style=" + style + '}';
    }
