...
public class ListBibl {
    ...
    public String toString() {
        return "ListBibl{" + "biblsAndBiblStructsAndListBibls=" + biblsAndBiblStructsAndListBibls + ", sameAs=" + sameAs + ", prev=" + prev + ", corresps=" + corresps + ", synches=" + synches + ", next=" + next + ", selects=" + selects + ", excludes=" + excludes + ", copyOf=" + copyOf + ", space=" + space + ", id=" + id + ", n=" + n + ", base=" + base + ", rends=" + rends + ", renditions=" + renditions + ", lang=" + lang + ", style=" + style + ", sortKey=" + sortKey + ", type=" + type + ", subtype=" + subtype + ", _default=" + _default + '}';
    }
}
