...
public class ProfileDesc {
    ...
    protected List<Object> abstractsAndTextClasses;
    ...
    /**
     * Gets the value of the abstractsAndTextClasses property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the abstractsAndTextClasses property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAbstractsAndTextClasses().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getAbstractsAndTextClasses() {
        if (abstractsAndTextClasses == null) {
            abstractsAndTextClasses = new ArrayList<Object>();
        }
        return this.abstractsAndTextClasses;
    }
    ...
    public String toString() {
        return "ProfileDesc{" + "abstractsAndTextClasses=" + abstractsAndTextClasses + ", sameAs=" + sameAs + ", prev=" + prev + ", corresps=" + corresps + ", synches=" + synches + ", next=" + next + ", selects=" + selects + ", excludes=" + excludes + ", copyOf=" + copyOf + ", space=" + space + ", id=" + id + ", n=" + n + ", base=" + base + ", rends=" + rends + ", renditions=" + renditions + ", lang=" + lang + ", style=" + style + '}';
    }
