...
public class Back {
    ...
    public String toString() {
        return "Back{" + "headsAndPSAndTrashes=" + headsAndPSAndTrashes + ", sameAs=" + sameAs + ", prev=" + prev + ", corresps=" + corresps + ", synches=" + synches + ", next=" + next + ", selects=" + selects + ", excludes=" + excludes + ", copyOf=" + copyOf + ", space=" + space + ", id=" + id + ", n=" + n + ", base=" + base + ", rends=" + rends + ", renditions=" + renditions + ", lang=" + lang + ", style=" + style + ", decls=" + decls + '}';
    }
