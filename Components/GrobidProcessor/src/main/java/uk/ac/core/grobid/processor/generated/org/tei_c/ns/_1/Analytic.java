...
public class Analytic {
    ...
    public String toString() {
        return "Analytic{" + "authorsAndEditorsAndTitles=" + authorsAndEditorsAndTitles + ", sameAs=" + sameAs + ", prev=" + prev + ", corresps=" + corresps + ", synches=" + synches + ", next=" + next + ", selects=" + selects + ", excludes=" + excludes + ", copyOf=" + copyOf + ", space=" + space + ", id=" + id + ", n=" + n + ", base=" + base + ", rends=" + rends + ", renditions=" + renditions + ", lang=" + lang + ", style=" + style + '}';
    }
