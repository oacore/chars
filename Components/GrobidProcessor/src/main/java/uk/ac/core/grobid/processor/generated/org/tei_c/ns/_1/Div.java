...
public class Div {
    ...
    @XmlElements({
        ...
        @XmlElement(name = "list", type = uk.ac.core.grobid.processor.generated.org.tei_c.ns._1.List.class),
    ...
    public String toString() {
        return "Div{" + "meetingsAndHeadsAndLinks=" + meetingsAndHeadsAndLinks + ", part=" + part + ", org=" + org + ", sample=" + sample + ", sameAs=" + sameAs + ", prev=" + prev + ", corresps=" + corresps + ", synches=" + synches + ", next=" + next + ", selects=" + selects + ", excludes=" + excludes + ", copyOf=" + copyOf + ", space=" + space + ", id=" + id + ", n=" + n + ", base=" + base + ", rends=" + rends + ", renditions=" + renditions + ", lang=" + lang + ", style=" + style + ", type=" + type + ", subtype=" + subtype + ", decls=" + decls + '}';
    }
