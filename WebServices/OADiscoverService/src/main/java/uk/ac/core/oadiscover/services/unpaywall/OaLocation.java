...
public class OaLocation {
    ...
    public String toString() {
        return "OaLocation{" + "evidence=" + evidence + ", hostType=" + hostType + ", isBest=" + isBest + ", license=" + license + ", pmhId=" + pmhId + ", updated=" + updated + ", url=" + url + ", urlForLandingPage=" + urlForLandingPage + ", urlForPdf=" + urlForPdf + ", version=" + version + '}';
    }
}
