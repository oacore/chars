...
public class StarterController {
    ...
    @RequestMapping("/grobid/citation/article/{articleId}")
    public String startTasksArticleId(@PathVariable(value = "articleId")Integer articleId) throws UnsupportedEncodingException {
        ...
        taskDescription.setType(TaskType.fromString("grobid-citation-parser-item"));
    ...
    @RequestMapping("/grobid/citation/repository/{repositoryId}")
