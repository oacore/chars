...
import uk.ac.core.workers.item.grobid.AffiliationParserWorker;
...
public class AffiliationParserConfiguration extends AbstractSingleItemWorkerConfiguration {

    @Override
    public QueueList getQueueNames() {
        QueueList queueList = new QueueList();
        queueList.add("grobid-affiliation-parser-item-queue");
        return queueList;
    }

    @Override
    public QueueWorker getQueueWorker() {
        return new AffiliationParserWorker();
    }
