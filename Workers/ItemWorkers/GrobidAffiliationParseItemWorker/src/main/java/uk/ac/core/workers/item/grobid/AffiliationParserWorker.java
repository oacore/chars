 ...
 */
public class AffiliationParserWorker extends SingleItemWorker {

    Logger logger = Logger.getLogger(AffiliationParserWorker.class.getName());
    
    @Autowired
    AffiliationParserService grobidProcessorService;
