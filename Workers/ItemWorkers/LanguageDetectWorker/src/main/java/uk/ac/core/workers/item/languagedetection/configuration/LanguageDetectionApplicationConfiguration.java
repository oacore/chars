package uk.ac.core.workers.item.languagedetection.configuration;
...
import uk.ac.core.workers.item.languagedetection.LanguageDetectionWorker;
...
public class LanguageDetectionApplicationConfiguration extends AbstractSingleItemWorkerConfiguration {

    @Bean
    public LanguageDetectionService getDetectionService(){
    ...
    public QueueList getQueueNames() {
        ...
        queueList.add("item-language-detection-queue");
        return queueList;
    }
